...
class BottomNavBarV2 extends StatefulWidget {
  ...
  @override
  BottomNavBarV2State createState() => BottomNavBarV2State();
}

class BottomNavBarV2State extends State<BottomNavBarV2> {
  int currentIndex = 0;
            ...
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Center(
                    heightFactor: 0.6,
                    child: FloatingActionButton(backgroundColor: Colors.orange, elevation: 0.1, onPressed: () {
